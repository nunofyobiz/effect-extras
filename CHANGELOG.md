...
- [#32](https://github.com/nunofyobiz/effect-extras/pull/32) [`4fa7e9b`](https://github.com/nunofyobiz/effect-extras/commit/4fa7e9b5587307bf8bd5e7b58f7fa85dceeeb6f2) Thanks [@bigpopakap](https://github.com/bigpopakap)! - Add `SchemaX.IntFromString`: a `Schema` that decodes a numeric string to a JS `number` but fails loudly when the value isn't a safe integer, instead of silently rounding it.
